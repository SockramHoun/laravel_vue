...
class PostController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $post = Post::find($id);
        if($post->count()){
            Post::whereId($id)->update($request->all());
            return response()->json(['status'=>'success', 'msg'=>'Post updated successfully.']);
        } else {
            return response()->json(['status'=>'error', 'msg'=>'error in updating']);
        }
    ...
    public function destroy($id)
    {
        ...
        if($post->count()){
            ...
            return response()->json(['status'=>'error', 'msg'=>'error in deletion']);
        }
    }
